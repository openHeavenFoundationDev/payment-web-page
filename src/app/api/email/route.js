...
export async function POST(request) {
  ...
  try {
    ...
    const mailOptions = {
      ...
      text: `Hi ${name}, pembayaran sebesar ${grossAmount} dengan order-ID ${orderId} telah berhasil. Saat ini kami sedang memproses mechandise lalu akan kami kirimkan ke alamat Anda. Anda juga dapat memeriksa kembali link pembayaran anda di link berikut ini ${paymentUrl}. Terimakasih Anda telah membeli produk merchandise Yayasan kami sebagai bentuk donasi, dana penjualan merchandise kami akan salurkan untuk pembangunan rumah singgah serta pendidikan gratis di Sorong Papua.`,
      // html: html,
    };
